...
public static class Test262Paths
{
    ...
    /// <summary>
    /// Locates the <c>tests/conformance/SharpTS.Test262/</c> project source directory — the place
    ...
    {
        // Test bin is at .../tests/conformance/SharpTS.Test262/bin/<config>/<tfm>/.
        // Worker bin mirrors at .../tests/conformance/SharpTS.Test262.Worker/bin/<config>/<tfm>/.
