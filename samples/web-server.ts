...
// Usage: sharpts samples/web-server.ts [port]
...
function showHelp(): void {
    ...
    console.log('');
    console.log('Usage:');
    console.log('  sharpts samples/web-server.ts [port]');
    console.log('  sharpts samples/web-server.ts --help');
    console.log('');
    ...
    console.log('  sharpts samples/web-server.ts');
    console.log('  sharpts samples/web-server.ts 8080');
    console.log('');
