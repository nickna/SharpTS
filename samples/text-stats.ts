...
// Usage: ./samples/text-stats.ts <file> [--top N] [--min-length N] [--case-sensitive]
//
...
function printUsage(): void {
    ...
    console.log('');
    console.log('Usage: ./samples/text-stats.ts <file> [options]');
    console.log('');
    console.log('Options:');
...
function main(args: string[]): number {
    ...
    try {
        ...
        console.error("Run './samples/text-stats.ts --help' for usage.");
        return 1;
    }
