...
with MemoryDiagnoser and interface/type-alias controls. Because construction
returns the records, it keeps boxed arrays; its time plus traversal time is not
