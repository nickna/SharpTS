...
static string DescriptorExpression(string adapter) => adapter switch
{
    ...
    "fragment" => "new StackPanelDescriptor(\"Fragment\", updateLayout: false)",
...
{
    var text = new StringBuilder("// <auto-generated />\n");
    text.AppendLine("import { CommonProps, GuiChild, GuiElement, TextualChild, ControlRef, WindowHandle, StackPanelHandle, GridHandle, BorderHandle, TextBlockHandle, ButtonHandle, TextBoxHandle, Thickness, HorizontalAlignment, VerticalAlignment, Orientation, ScrollBarVisibility, Theme, Stretch, SelectionMode, Dock, FontWeight, TextAlignment, ContentStyleProps, TextStyleProps } from \"./runtime-types\";");
    ...
    foreach (JsonObject control in manifest["controls"]!.AsArray().Select(item => item!.AsObject()).Where(c => Required(c, "kind") != "Fragment"))
    {
