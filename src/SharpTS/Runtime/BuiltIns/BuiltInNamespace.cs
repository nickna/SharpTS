...
/// <summary>
/// Represents a built-in namespace like Math, Object, Array, JSON, console, or Promise.
/// </summary>
...
/// <param name="GetMethod">Function to look up a method by name, returns null if not found. Can return BuiltInMethod or BuiltInAsyncMethod.</param>
public record BuiltInNamespace(
    string Name,
    bool IsSingleton,
    Func<object>? SingletonFactory,
    Func<string, ISharpTSCallable?> GetMethod
);
