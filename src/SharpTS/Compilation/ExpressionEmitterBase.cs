...
public abstract partial class ExpressionEmitterBase : IEmitterContext
{
    ...
    protected bool TryEmitBuiltInClassType(string name)
    {
        Type? t = name switch
        {
            ...
            "Int8Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().Int8ArrayType,
            "Uint8Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().Uint8ArrayType,
            "Uint8ClampedArray" => Ctx.Runtime!.TypedArrays.RequireImplementation().Uint8ClampedArrayType,
            "Int16Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().Int16ArrayType,
            "Uint16Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().Uint16ArrayType,
            "Int32Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().Int32ArrayType,
            "Uint32Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().Uint32ArrayType,
            "Float32Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().Float32ArrayType,
            "Float64Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().Float64ArrayType,
            "BigInt64Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().BigInt64ArrayType,
            "BigUint64Array" => Ctx.Runtime!.TypedArrays.RequireImplementation().BigUint64ArrayType,
            _ => null
        };
