...
public class AsyncIteratorEdgeCaseTests
{
    ...
    [Fact]
    public void AsyncIterator_RejectedPromiseInNext_PropagatesError()
    {
        var source = """
            const iterable: any = {
                callCount: 0,
    ...
    [Fact]
    public void AsyncIterator_ThrowInForAwaitBody_CatchesError()
    {
        var source = """
            async function* gen() {
                yield 1;
    ...
    [Fact]
    public void AsyncGenerator_TryFinally_CleanupRuns()
    {
        var source = """
    ...
    [Fact]
    public void AsyncIterator_YieldZero_WorksCorrectly()
    {
