...
public class NumberTests
{
    ...
    [Fact]
    public void Number_toFixed_FormatsDecimals()
    {
        var source = """
    ...
    [Fact]
    public void Number_toPrecision_FormatsPrecision()
    {
        var source = """
    ...
    [Fact]
    public void Number_toExponential_FormatsExponential()
    {
        var source = """
            let n: number = 12345;
    ...
    [Fact]
    public void Number_toString_WithRadix()
    {
        var source = """
