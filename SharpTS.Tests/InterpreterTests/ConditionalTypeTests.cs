...
public class ConditionalTypeTests
{
    ...
    [Fact]
    public void ConditionalType_BasicTrue_ReturnsTrue()
    {
        var source = """
    ...
    [Fact]
    public void ConditionalType_BasicFalse_ReturnsFalse()
    {
        var source = """
            type IsString<T> = T extends string ? true : false;
    ...
    [Fact]
    public void ConditionalType_StringLiteralExtendsString_ReturnsTrue()
    {
        var source = """
    ...
    [Fact]
    public void ConditionalType_NumberLiteralExtendsNumber_ReturnsTrue()
    {
        var source = """
    ...
    [Fact]
    public void ConditionalType_BooleanExtendsBoolean_ReturnsTrue()
    {
        var source = """
    ...
    [Fact]
    public void ConditionalType_NullExtendsNull_ReturnsTrue()
    {
        var source = """
    ...
    [Fact]
    public void ConditionalType_ArrayExtendsArray_ReturnsTrue()
    {
        var source = """
    ...
    [Fact]
    public void ConditionalType_NonArrayExtendsArray_ReturnsFalse()
    {
        var source = """
            type IsArray<T> = T extends any[] ? true : false;
    ...
    [Fact]
    public void ConditionalType_AnyExtendsAny_ReturnsTrue()
    {
        var source = """
    ...
    [Fact]
    public void ConditionalType_NeverExtendsAny_ReturnsNever()
    {
    ...
    [Fact]
    public void ConditionalType_RecordExtendsRecord_ReturnsTrue()
    {
    ...
    [Fact]
    public void ConditionalType_PrimitiveExtendsRecord_ReturnsFalse()
    {
        // Use { } instead of object keyword
        var source = """
            type IsRecord<T> = T extends { x: number } ? "match" : "nomatch";
    ...
    [Fact]
    public void ConditionalType_UnionDistribution_DistributesCorrectly()
    {
    ...
    [Fact]
    public void ConditionalType_ToArray_DistributesOverUnion()
    {
    ...
    [Fact]
    public void ConditionalType_FilterStrings_FiltersUnion()
    {
    ...
    [Fact]
    public void ConditionalType_NonNullable_FiltersNull()
    {
    ...
    [Fact]
    public void ConditionalType_Extract_ExtractsMatchingTypes()
    {
    ...
    [Fact]
    public void ConditionalType_Exclude_ExcludesMatchingTypes()
    {
    ...
    [Fact]
    public void ConditionalType_AllNever_ResultsInNever()
    {
    ...
    [Fact]
    public void ConditionalType_SingleUnionMember_NoDistribution()
    {
    ...
    [Fact]
    public void ConditionalType_UnionWithNever_NeverDisappears()
    {
        // string | never = string
        var source = """
    ...
    [Fact]
    public void ConditionalType_DistributeWithLiteral_Works()
    {
    ...
    [Fact]
    public void InferType_ArrayElement_ExtractsElement()
    {
        var source = """
    ...
    [Fact]
    public void InferType_NumberArrayElement_ExtractsNumber()
    {
        var source = """
            type ElementType<T> = T extends (infer U)[] ? U : never;
    ...
    [Fact]
    public void InferType_NonArrayReturnsNever_FallsBack()
    {
    ...
    [Fact]
    public void InferType_PromiseValue_ExtractsValue()
    {
        var source = """
    ...
    [Fact]
    public void InferType_NonPromise_ReturnsSelf()
    {
        var source = """
            type Awaited<T> = T extends Promise<infer U> ? U : T;
    ...
    [Fact]
    public void InferType_InferUsedInTrueBranch_Works()
    {
        var source = """
    ...
    [Fact]
    public void InferType_NestedArray_FlattenOnce()
    {
    ...
    [Fact]
    public void InferType_MapValue_ExtractsValue()
    {
        var source = """
    ...
    [Fact]
    public void InferType_SetElement_ExtractsElement()
    {
        var source = """
    ...
    [Fact]
    public void InferType_UnionDistribution_InfersFromEach()
    {
    ...
    [Fact]
    public void ConditionalType_NestedConditional_Works()
    {
        var source = """
            type TypeName<T> =
    ...
    [Fact]
    public void ConditionalType_NestedConditional_SecondBranch()
    {
        var source = """
            type TypeName<T> =
                T extends string ? "string" :
    ...
    [Fact]
    public void ConditionalType_NestedConditional_ThirdBranch()
    {
        var source = """
            type TypeName<T> =
                T extends string ? "string" :
    ...
    [Fact]
    public void ConditionalType_NestedConditional_FallbackBranch()
    {
        var source = """
            type TypeName<T> =
                T extends string ? "string" :
    ...
    [Fact]
    public void ConditionalType_ConditionalInTrueBranch_Works()
    {
    ...
    [Fact]
    public void ConditionalType_ConditionalInFalseBranch_Works()
    {
        // Test that conditional types evaluate correct branches
        var source = """
    ...
    [Fact]
    public void ConditionalType_TwoTypeParams_Works()
    {
        var source = """
    ...
    [Fact]
    public void ConditionalType_ThreeTypeParams_Works()
    {
        var source = """
    ...
    [Fact]
    public void UtilityType_NonNullable_Implementation()
    {
        var source = """
    ...
    [Fact]
    public void UtilityType_Extract_Implementation()
    {
    ...
    [Fact]
    public void UtilityType_Exclude_Implementation()
    {
        // Use type alias for the union to avoid parser issues with union in generic args
        var source = """
            type StringUnion = "a" | "b" | "c";
    ...
    [Fact]
    public void UtilityType_Awaited_Simple()
    {
        var source = """
    ...
    [Fact]
    public void UtilityType_UnwrapArray_Implementation()
    {
        var source = """
    ...
    [Fact]
    public void UtilityType_IsAny_SimpleCheck()
    {
        var source = """
            type IsString<T> = T extends string ? "yes" : "no";
    ...
    [Fact]
    public void EdgeCase_EmptyUnion_IsNever()
    {
    ...
    [Fact]
    public void EdgeCase_UnknownExtendsUnknown_Works()
    {
        var source = """
    ...
    [Fact]
    public void EdgeCase_VoidExtends_Works()
    {
        var source = """
    ...
    [Fact]
    public void EdgeCase_StringLiteralUnion_Distributes()
    {
    ...
    [Fact]
    public void EdgeCase_TrueLiteralCheck()
    {
    ...
    [Fact]
    public void EdgeCase_StringUnionDistribution_Works()
    {
        // Use type alias for the union
        var source = """
            type Letters = "a" | "b" | "c";
