...
public class MapSetTests
{
    ...
    [Fact]
    public void Map_ForEach_IteratesAllEntries()
    {
        var source = @"
            let m = new Map<string, number>();
            m.set('a', 1);
    ...
    // ========== Map Object Key Reference Equality ==========

    [Fact]
    public void Map_ObjectKeys_UseReferenceEquality()
    {
        var source = @"
            let m = new Map();
            let obj1 = { x: 1 };
    ...
    [Fact]
    public void Map_StringKeys_UseValueEquality()
    {
        var source = @"
            let m = new Map<string, number>();
            let key1 = 'hello';
    ...
    [Fact]
    public void Set_ForEach_IteratesAllValues()
    {
        var source = @"
            let s = new Set<number>();
            s.add(10);
    ...
    // ========== Set Object Reference Equality ==========

    [Fact]
    public void Set_ObjectValues_UseReferenceEquality()
    {
        var source = @"
            let s = new Set();
            let obj1 = { id: 1 };
