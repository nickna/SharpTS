...
public class ObjectFeatureTests
{
    ...
    // Note: Object.fromEntries(Map) in compiled mode requires Map.entries() explicit call
    // since direct Map iteration through Symbol.iterator may not return the expected format.
    // Use Object.fromEntries(map.entries()) or array literals for compiled code.
    [Fact]
    public void Object_FromEntries_WithMapEntries()
    {
        var source = """
