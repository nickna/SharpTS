...
/// <summary>
/// Tests for the crypto module's RSA encryption/decryption functions in compiled mode.
/// </summary>
public class CryptoRsaEncryptCompiledTests
{
...
""";
    ...
    [Fact]
    public void Compiled_Crypto_PublicEncrypt_ReturnsBuffer()
    {
    ...
    [Fact]
    public void Compiled_Crypto_PublicEncrypt_PrivateDecrypt_Roundtrip()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = $$"""
    ...
    [Fact]
    public void Compiled_Crypto_PublicEncrypt_PrivateDecrypt_WithGeneratedKeyPair()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_PublicEncrypt_StringInput()
    {
    ...
    [Fact]
    public void Compiled_Crypto_PrivateDecrypt_FailsWithWrongKey()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_EncryptionProducesDifferentOutputEachTime()
    {
    ...
    [Fact]
    public void Compiled_Crypto_PublicEncrypt_ThrowsOnInvalidKey()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_PublicEncrypt_MessageSizeLimit()
    {
