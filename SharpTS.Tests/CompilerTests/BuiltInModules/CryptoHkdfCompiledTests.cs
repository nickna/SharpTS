...
/// <summary>
/// Tests for the crypto module's hkdfSync function in compiled mode.
/// </summary>
public class CryptoHkdfCompiledTests
{
    [Fact]
    public void Compiled_Crypto_HkdfSync_ReturnsBuffer()
    {
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_DifferentKeyLengths()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_Deterministic()
    {
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_DifferentInputsProduceDifferentOutput()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_DifferentSalts()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_DifferentInfo()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_EmptySaltAndInfo()
    {
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_StringInputs()
    {
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_SHA1()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_SHA384()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_SHA512()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_InvalidDigest_Throws()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_ZeroKeyLength()
    {
        var files = new Dictionary<string, string>
        {
            ["main.ts"] = """
    ...
    [Fact]
    public void Compiled_Crypto_HkdfSync_RFC5869_TestVector1()
    {
