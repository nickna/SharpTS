...
{
    [Fact]
    public void AsyncMethod_ReadThisProperty()
    {
        var source = """
            class Counter {
                value: number = 42;
    ...
    [Fact]
    public void AsyncMethod_WriteThisProperty()
    {
        var source = """
            class Counter {
                value: number = 0;
    ...
    [Fact]
    public void AsyncMethod_IncrementThisProperty()
    {
        var source = """
            class Counter {
                value: number = 0;
    ...
    [Fact]
    public void AsyncMethod_MultipleProperties()
    {
        var source = """
            class Point {
                x: number = 0;
    ...
    [Fact]
    public void AsyncMethod_PropertyWithAwait()
    {
        var source = """
    ...
    [Fact]
    public void AsyncMethod_AssignmentExpression()
    {
    ...
    [Fact]
    public void AsyncMethod_ChainedPropertyAccess()
    {
        var source = """
            class Inner {
                value: number = 100;
