...
public sealed class MultiWindowIntegrationTests
{
    ...
    public async Task OwnedWindowsAndIsolatedFailuresMatchInBothGuestModes()
    {
        ...
        string fixture = Path.Combine(
            repositoryRoot, "SharpTS.Gui.Conformance.Tests", "Fixtures", "MultiWindow", "main.tsx");
        ...
        try
        {
            ...
            await File.WriteAllTextAsync(
                ...
                """
                {
                  ...
                  "descriptorSchemaHash": "bbe93f8d6f526acb9a579e57777a66787a7611db9b6a2c743b75720964cfa800"
                }
                """);
