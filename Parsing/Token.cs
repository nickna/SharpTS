...
public enum TokenType
{
    ...
    // Keywords
    ABSTRACT, AS, ASYNC, AWAIT, BREAK, CASE, CONST, CLASS, CONSTRUCTOR, CONTINUE, DECLARE, DEFAULT, DO, ELSE, ENUM, EXPORT, EXTENDS, FALSE, FROM, FUNCTION, FOR, GET, IF,
    IMPLEMENTS, IMPORT, IN, INFER, INSTANCEOF, INTERFACE, KEYOF, LET, NAMESPACE, NEVER,
    NEW, NULL, OF, OVERRIDE, PRIVATE, PROTECTED, PUBLIC, READONLY, RETURN, SET, STATIC, SUPER, SWITCH, THIS, THROW, TRUE, TRY, CATCH, FINALLY, TYPE, TYPEOF, UNDEFINED, UNKNOWN, VAR, WHILE,
