...
public enum TokenType
{
    ...
    // Keywords
    ABSTRACT, ACCESSOR, AS, ASSERTS, ASYNC, AWAIT, BREAK, CASE, CONST, CLASS, CONSTRUCTOR, CONTINUE, DECLARE, DEFAULT, DO, ELSE, ENUM, EXPORT, EXTENDS, FALSE, FROM, FUNCTION, FOR, GET, IF,
    IMPLEMENTS, IMPORT, IN, INFER, INSTANCEOF, INTERFACE, IS, KEYOF, LET, NAMESPACE, NEVER,
