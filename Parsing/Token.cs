...
public enum TokenType
{
    ...
    // Keywords
    ABSTRACT, AS, ASSERTS, ASYNC, AWAIT, BREAK, CASE, CONST, CLASS, CONSTRUCTOR, CONTINUE, DECLARE, DEFAULT, DO, ELSE, ENUM, EXPORT, EXTENDS, FALSE, FROM, FUNCTION, FOR, GET, IF,
