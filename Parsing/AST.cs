...
public abstract record Stmt
{
    ...
    public record Function(Token Name, List<TypeParam>? TypeParams, List<Parameter> Parameters, List<Stmt> Body, string? ReturnType, bool IsStatic = false, AccessModifier Access = AccessModifier.Public) : Stmt;
