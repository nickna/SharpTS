...
public static class WellKnownSymbolTypes
{
    ...
    public static readonly TypeInfo.Interface SymbolConstructor = new(
        ...
        new Dictionary<string, TypeInfo>
        {
            ...
            ["search"] = Search,
            ["split"] = Split,
            ["for"] = new TypeInfo.Function([TypeInfo.String.Shared], TypeInfo.Symbol.Shared, 1, false, null, ["key"]),
            ["keyFor"] = new TypeInfo.Function([TypeInfo.Symbol.Shared], new TypeInfo.Union([TypeInfo.String.Shared, TypeInfo.Undefined.Shared]), 1, false, null, ["sym"]),
