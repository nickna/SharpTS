...
public partial class RuntimeEmitter
{
    ...
    private void EmitFetch(TypeBuilder typeBuilder, EmittedRuntime runtime)
    {
        ...
        fetchIL.Emit(OpCodes.Call, typeof(Task).GetMethod("Run", 1, [_types.MakeGenericType(typeof(Func<>), Type.MakeGenericMethodParameter(0))])!.MakeGenericMethod(typeof(object)));
