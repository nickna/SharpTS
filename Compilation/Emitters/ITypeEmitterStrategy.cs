...
public interface ITypeEmitterStrategy
{
    ...
    /// </summary>
    /// <param name="emitter">The IL emitter to use for code generation.</param>
    ...
    bool TryEmitMethodCall(ILEmitter emitter, Expr receiver, string methodName, List<Expr> arguments);
    ...
    bool TryEmitPropertyGet(ILEmitter emitter, Expr receiver, string propertyName);
}
...
public interface IStaticTypeEmitterStrategy
{
    ...
    /// <param name="arguments">The method arguments.</param>
    /// <returns>True if this strategy handled the method call; false to try the next strategy.</returns>
    bool TryEmitStaticCall(ILEmitter emitter, string methodName, List<Expr> arguments);
    ...
    /// <returns>True if this strategy handled the property access; false to try the next strategy.</returns>
    bool TryEmitStaticPropertyGet(ILEmitter emitter, string propertyName);
}
